...
public class TclParser extends Parser {
	...
	public static final int
		...
		Identifier=204, Text=205, SpecialChars=206, String=207, OneLineComment=208, 
		EmptyLine=209, WhiteSpace=210, OperatorAB=211, OperatorA=212;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'close_vcd'", "'save_wave_config'", "'close_sim'", "'set_global_assignment'", 
			"'set_instance_assignment'", "'set_location_assignment'", "'export_assignments'", 
			"'project_new'", "'project_open'", "'project_close'", "'if'", "'else'", 
			"'elseif'", "'switch'", "'default'", "'while'", "'for'", "'require'", 
			"'provide'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			"Identifier", "Text", "SpecialChars", "String", "OneLineComment", "EmptyLine", 
			"WhiteSpace", "OperatorAB", "OperatorA"
		};
	}
	...
	public final Source_textContext source_text() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & -600L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & -1L) != 0) || ((((_la - 128)) & ~0x3f) == 0 && ((1L << (_la - 128)) & -1L) != 0) || ((((_la - 192)) & ~0x3f) == 0 && ((1L << (_la - 192)) & 1241935L) != 0)) {
				{
				{
				setState(86);
				commandLine();
	...
	public final CommandNameContext commandName() throws RecognitionException {
		...
		try {
			...
			setState(144);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & -1024L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & -1L) != 0) || ((((_la - 128)) & ~0x3f) == 0 && ((1L << (_la - 128)) & -1L) != 0) || ((((_la - 192)) & ~0x3f) == 0 && ((1L << (_la - 192)) & 4103L) != 0)) ) {
	...
	public final SwitchContext switch_() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 168L) != 0) || ((((_la - 204)) & ~0x3f) == 0 && ((1L << (_la - 204)) & 271L) != 0) );
			setState(338);
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (_la==T__198) {
