...
public class TclParser extends Parser {
	...
	public static final int
		...
		Identifier=25, Text=26, SpecialChars=27, String=28, OneLineComment=29, 
		EmptyLine=30, WhiteSpace=31, OperatorAB=32, OperatorA=33;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'?'", "':'", "'('", "')'", "'{'", "'}'", "'['", "';'", "']'", 
			"'if'", "'else'", "'elseif'", "'switch'", "'default'", "'while'", "'for'", 
			"'foreach'", "'proc'", "'package'", "'require'", "'provide'", "'namespace'", 
			"'eval'", "'regexp'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, "Identifier", "Text", "SpecialChars", "String", "OneLineComment", 
	...
	public final Source_textContext source_text() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 10188989864L) != 0)) {
				{
				{
				setState(86);
				commandLine();
	...
	public final SwitchContext switch_() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 9093251240L) != 0) );
			setState(338);
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (_la==T__13) {
