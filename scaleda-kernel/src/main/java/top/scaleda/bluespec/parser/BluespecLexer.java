...
public class BluespecLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"LineComment", "Whitespace", "CharacterConstant", "CCharSequence", "CChar", 
			"NoneWhitespace", "EscapeSequence", "SimpleEscapeSequence", "OctalEscapeSequence", 
