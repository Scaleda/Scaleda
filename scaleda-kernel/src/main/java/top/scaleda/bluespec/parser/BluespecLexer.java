...
public class BluespecLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"CChar", "NoneWhitespace", "EscapeSequence", "SimpleEscapeSequence", 
			"OctalEscapeSequence", "HexadecimalEscapeSequence", "StringLiteral", 
			"SChar", "HexadecimalDigit", "OctalDigit", "SCharSequence", "Digit", 
			"Identifier", "FileName", "IdentifierNondigit", "Nondigit", "IntLiteral", 
			"SizedIntLiteral", "UnsizedIntLiteral", "BaseLiteral", "DecNum", "BitWidth", 
			"Sign", "DecDigits", "DecDigitsUnderscore", "HexDigitsUnderscore", "OctDigitsUnderscore", 
			"BinDigitsUnderscore", "RealLiteral", "Exp", "CompilerDirective", "LineNumber", 
			"Level", "MacroName", "MacroFormals", "MacroInvocation_", "MacroInvocation", 
			"MacroActuals", "SubstText"
		};
	}
