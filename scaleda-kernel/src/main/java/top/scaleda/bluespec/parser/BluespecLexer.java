// Generated from /home/chiro/programs/scaleda/scaleda-kernel/src/main/antlr/bluespec/BluespecLexer.g4 by ANTLR 4.13.1
...
public class BluespecLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"K_Action", "K_ActionValue", "K_BVI", "K_C", "K_CF", "K_E", "K_SB", "K_SBR", 
			"K_action", "K_endaction", "K_actionvalue", "K_endactionvalue", "K_ancestor", 
			"K_begin", "K_bit", "K_case", "K_endcase", "K_clocked_by", "K_default", 
			"K_default_clock", "K_default_reset", "K_dependencies", "K_deriving", 
			"K_determines", "K_e", "K_else", "K_enable", "K_end", "K_enum", "K_export", 
			"K_for", "K_function", "K_endfunction", "K_if", "K_ifc_inout", "K_import", 
			"K_inout", "K_input_clock", "K_input_reset", "K_instance", "K_endinstance", 
			"K_interface", "K_endinterface", "K_let", "K_match", "K_matches", "K_method", 
			"K_endmethod", "K_module", "K_endmodule", "K_numeric", "K_output_clock", 
			"K_output_reset", "K_package", "K_endpackage", "K_parameter", "K_par", 
			"K_endpar", "K_path", "K_port", "K_provisos", "K_reset_by", "K_return", 
			"K_rule", "K_endrule", "K_rules", "K_endrules", "K_same_family", "K_schedule", 
			"K_struct", "K_tagged", "K_type", "K_typeclass", "K_endtypeclass", "K_typedef", 
			"K_union", "K_valueOf", "K_valueof", "K_void", "K_while", "K_alias", 
			"K_always", "K_always_comb", "K_always_ff", "K_always_latch", "K_and", 
			"K_assert", "K_assert_strobe", "K_assign", "K_assume", "K_automatic", 
			...
			"CharacterConstant", "CCharSequence", "CChar", "NoneWhitespace", "EscapeSequence", 
			"SimpleEscapeSequence", "OctalEscapeSequence", "HexadecimalEscapeSequence", 
			"StringLiteral", "SChar", "HexadecimalDigit", "OctalDigit", "SCharSequence", 
			"Digit", "Identifier", "FileName", "IdentifierNondigit", "Nondigit", 
			"IntLiteral", "SizedIntLiteral", "UnsizedIntLiteral", "BaseLiteral", 
	...
	public BluespecLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "BluespecLexer.g4"; }
