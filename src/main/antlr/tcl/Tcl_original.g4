...
asignacion	:	var | '$' IDENTIFICADOR indice | agrup  ;

indice	:	'(' val_indice ')' ;
val_indice	:	var | agrup | '$' IDENTIFICADOR indice ;

var	:	VAR_STRING | VAR_INTEGER | VAR_DOUBLE  ;

incremento	:	VAR_INTEGER ;
...
term	:	'$' IDENTIFICADOR indice | agrup | var | '(' exp_or ')'  ;
