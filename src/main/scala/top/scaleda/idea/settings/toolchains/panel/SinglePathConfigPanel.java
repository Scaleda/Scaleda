...
public class SinglePathConfigPanel extends AbstractConfigPanel {
    ...
    public SinglePathConfigPanel(ToolchainProfile profile) {
        profileNameField.setText(profile.profileName());
        toolchainPathField.setText(new File(profile.path()).getAbsolutePath());
        toolchainPathField.addBrowseFolderListener(new TextBrowseFolderListener(FileChooserDescriptorFactory.createSingleFolderDescriptor()));
        ...
        toolchainPathField.getTextField().getDocument().addDocumentListener(new DocumentAdapter() {
            @Override
            protected void textChanged(@NotNull DocumentEvent e) {
                profile.path_$eq(toolchainPathField.getText());
                profile.edited_$eq(true);
            }
        });
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        toolchainPathField = new TextFieldWithBrowseButton();
        optionPanel.add(toolchainPathField, new GridConstraints(2, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
