...
import top.scaleda.verilog.psi.nodes.*;
import top.scaleda.verilog.psi.nodes.always.*;
import top.scaleda.verilog.psi.nodes.assignments.BlockingAssignmentPsiNode;
import top.scaleda.verilog.psi.nodes.assignments.NetAssignmentPsiNode;
import top.scaleda.verilog.psi.nodes.assignments.NonblockingAssignmentPsiNode;
import top.scaleda.verilog.psi.nodes.block.CaseBodyPsiNode;
import top.scaleda.verilog.psi.nodes.block.CaseDefaultPsiNode;
import top.scaleda.verilog.psi.nodes.block.CaseStatementPsiNode;
import top.scaleda.verilog.psi.nodes.condition.ConditionalStatementPsiNode;
import top.scaleda.verilog.psi.nodes.block.SeqBlockPsiNode;
import top.scaleda.verilog.psi.nodes.condition.ConditionalStatementChainPsiNode;
import top.scaleda.verilog.psi.nodes.condition.ConditionalStatementHeadPsiNode;
import top.scaleda.verilog.psi.nodes.condition.ConditionalStatementTailPsiNode;
import top.scaleda.verilog.psi.nodes.expression.*;
import top.scaleda.verilog.psi.nodes.incompleted.IncompleteConditionPsiNode;
import top.scaleda.verilog.psi.nodes.instantiation.*;
import top.scaleda.verilog.psi.nodes.macro.MacroDeclarationPsiNode;
import top.scaleda.verilog.psi.nodes.macro.MacroIdentifierPsiNode;
import top.scaleda.verilog.psi.nodes.module.*;
import top.scaleda.verilog.psi.nodes.signal.*;
import top.scaleda.verilog.psi.nodes.signal.parameter.ListOfParamAssignmentsPsiNode;
import top.scaleda.verilog.psi.nodes.signal.parameter.ParamAssignmentPsiNode;
...
public class VerilogPsiNodeFactory {
  ...
  private static final Language LANGUAGE = VerilogLanguage$.MODULE$.INSTANCE();
