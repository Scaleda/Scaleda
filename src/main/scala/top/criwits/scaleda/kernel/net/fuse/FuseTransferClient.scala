...
import kernel.net.fuse.fs.{RemoteFuseGrpc, RemoteFuseTransferGrpc}
...
object FuseTransferClient {
  ...
  def asStream(dataProvider: RemoteFuseGrpc.RemoteFuse, host: String = "127.0.0.1", port: Int = DEFAULT_PORT) = {
