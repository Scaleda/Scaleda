...
public class NetIdentifierPsiNode extends ANTLRPsiNode implements PsiNameIdentifierOwner, StructureViewNode {
    ...
    public String getElementName() {
        if (getName() == null) return "(unknown)";
            ...
            var parent = PsiTreeUtil.getParentOfType(this, NetDeclarationPsiNode.class);
            if (parent != null) {
