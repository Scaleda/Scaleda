...
public class VerilogLexer extends Lexer {
	...
	public static final int
		...
		K_end=32, K_endcase=33, K_endconfig=34, K_endfunction=35, K_endgenerate=36, 
		K_endprimitive=37, K_endspecify=38, K_endtable=39, K_endtask=40, K_event=41, 
		K_for=42, K_force=43, K_forever=44, K_fork=45, K_highz0=46, K_highz1=47, 
		K_function=48, K_generate=49, K_genvar=50, K_if=51, K_ifnone=52, K_include=53, 
		K_initial=54, K_inout=55, K_input=56, K_instance=57, K_integer=58, K_join=59, 
		K_large=60, K_liblist=61, K_library=62, K_localparam=63, K_medium=64, 
		K_nand=65, K_negedge=66, K_nmos=67, K_nor=68, K_noshowcancelled=69, K_not=70, 
		K_notif0=71, K_notif1=72, K_or=73, K_output=74, K_parameter=75, K_pmos=76, 
		K_posedge=77, K_primitive=78, K_pull0=79, K_pull1=80, K_pulldown=81, K_pullup=82, 
		K_pulsestyle_ondetect=83, K_pulsestyle_onevent=84, K_rcmos=85, K_real=86, 
		K_realtime=87, K_reg=88, K_release=89, K_repeat=90, K_rnmos=91, K_rpmos=92, 
		K_rtran=93, K_rtranif0=94, K_rtranif1=95, K_scalared=96, K_showcancelled=97, 
		K_signed=98, K_small=99, K_specify=100, K_specparam=101, K_strong0=102, 
		K_strong1=103, K_supply0=104, K_supply1=105, K_table=106, K_task=107, 
		K_time=108, K_timescale=109, K_tran=110, K_tranif0=111, K_tranif1=112, 
		K_tri=113, K_tri0=114, K_tri1=115, K_triand=116, K_trior=117, K_trireg=118, 
		K_use=119, K_vectored=120, K_wait=121, K_wand=122, K_weak0=123, K_weak1=124, 
		K_while=125, K_wire=126, K_wor=127, K_xnor=128, K_xor=129, Semicolon=130, 
		Colon=131, Dollar=132, Dot=133, Plus=134, Minus=135, Comma=136, Question_mark=137, 
		Exclamation_mark=138, Left_parenthes=139, Right_parenthes=140, Left_bracket=141, 
		Right_bracket=142, Left_brace=143, Right_brace=144, Left_angle_bracket=145, 
		Right_angle_bracket=146, Sharp=147, Underscore=148, Slash=149, Backslash=150, 
		Eq=151, Eq_eq=152, Eq_eq_eq=153, Not_eq=154, Not_eq_eq=155, Left_angle_eq=156, 
		Right_angle_eq=157, At=158, Asterisk=159, Left_arrow=160, Right_arrow=161, 
		Left_asterisk_arrow=162, Right_asterisk_arrow=163, Percent=164, Ampersant=165, 
		Vertical_line=166, Apostrophe=167, Tilda=168, Hat=169, Quotation_mark=170, 
		Real_number=171, Decimal_number=172, Binary_number=173, Octal_number=174, 
		Hex_number=175, Escaped_identifier=176, Simple_identifier=177, Dollar_identifier=178, 
		Time_identifier=179, String=180, One_line_comment=181, Block_comment=182, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"K_defparam", "K_design", "K_disable", "K_edge", "K_else", "K_end", "K_endcase", 
			"K_endconfig", "K_endfunction", "K_endgenerate", "K_endprimitive", "K_endspecify", 
			"K_endtable", "K_endtask", "K_event", "K_for", "K_force", "K_forever", 
			"K_fork", "K_highz0", "K_highz1", "K_function", "K_generate", "K_genvar", 
			"K_if", "K_ifnone", "K_include", "K_initial", "K_inout", "K_input", "K_instance", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'endconfig'", "'endfunction'", "'endgenerate'", "'endprimitive'", "'endspecify'", 
			"'endtable'", "'endtask'", "'event'", "'for'", "'force'", "'forever'", 
			"'fork'", "'highz0'", "'highz1'", "'function'", "'generate'", "'genvar'", 
